 ...
 * 
 */
 package com.shanhy.schedulecenter.examples.example14;
...
public class PriorityExample {
  ...
  public void run() throws Exception {
    ...
    SchedulerFactory sf = new StdSchedulerFactory("com.shanhy.schedulecenter.examples/example14/quartz_priority.properties");
